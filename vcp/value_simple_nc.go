...
func (autoSetup) EnableContinuousperiodicAutoSetup() VCP {
...
func (autoColorSetup) EnableContinuousperiodicAutoSetup() VCP {
...
func (displayMode) StandardDefaultMode() VCP { return VCP{code: _DisplayMode, value: 0x00} }
...
func (displayMode) StandardDefaultModeWithIntermediatePowerConsumption() VCP {
	return VCP{code: _DisplayMode, value: 0x08}
}

func (displayMode) StandardDefaultModeWithLowPowerConsumption() VCP {
